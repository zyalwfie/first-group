<header
    ...
    <nav class="flex gap-x-3 flex-1 justify-end md:justify-between items-center">
        ...
        <div class="hidden md:flex gap-3">
            ...
            <a href="{{ route('blogs.index') }}" class="font-newsCycle text-lg font-semibold hover:text-red transition {{ Request::is('blogs*') ? 'text-red' : '' }}">Blogs</a>
        ...
        <div class="fixed inset-0 bg-[rgba(0,0,0,0.5)] backdrop-blur-sm hidden" id="overlay">
            <div class="flex flex-col justify-between bg-vanilla w-[60%] h-full p-4 absolute -translate-x-full transition" id="sidebar">
                <div class="flex flex-col gap-3">
                    ...
                    <a href="{{ route('blogs.index') }}" class="flex items-center rounded-md gap-3 p-2 font-newsCycle text-lg font-semibold hover:text-red transition {{ Request::is('blogs*') ? 'bg-red text-flashWhite' : '' }}"><span><i class='bx bxs-news'></i></span>Blogs</a>
