<x-layout :isNecessary="true">
    ...
    <main class="max-w-[800px] lg:my-12 md:mx-auto">
        <div class="rounded-md p-4 bg-flashWhite shadow shadow-grey flex flex-col lg:flex-row gap-5">
            <img src="{{ asset('img/signup.svg') }}" alt="Illustration" class="order-2 lg:max-w-96">
            <div class="bg-vanilla p-6 rounded-md flex-1 flex flex-col order-1 lg:max-w-96 gap-14">
